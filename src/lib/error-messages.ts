...
export interface ErrorContext {
  operation: 'add' | 'edit' | 'delete' | 'reset-password' | 'lock-account' | 'reset-code' | 'upload' | 'fetch';
 ...
 */
export function getErrorMessage(error: Error | string | unknown, context: ErrorContext): string {
...
export const ErrorContexts = {
  addUser: (entity: 'student' | 'adviser'): ErrorContext => ({ operation: 'add', entity }),
  editUser: (entity: 'student' | 'adviser' | 'group' | 'document'): ErrorContext => ({ operation: 'edit', entity }),
  deleteUser: (entity: 'student' | 'adviser' | 'group'): ErrorContext => ({ operation: 'delete', entity }),
  ...
  resetPassword: (): ErrorContext => ({ operation: 'reset-password', entity: 'user' }),
  lockAccount: (action: 'lock' | 'unlock'): ErrorContext => ({ 
    operation: 'lock-account', 
    entity: 'user', 
    details: action 
  }),
  resetCode: (entity: 'adviser'): ErrorContext => ({ operation: 'reset-code', entity }),
  uploadFile: (): ErrorContext => ({ operation: 'upload', entity: 'data' }),
  fetchData: (entity: 'user' | 'student' | 'adviser' | 'group' | 'document'): ErrorContext => ({ 
    operation: 'fetch', 
    entity 
  }),
};
